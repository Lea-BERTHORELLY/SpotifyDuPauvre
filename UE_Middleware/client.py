...
with Ice.initialize(sys.argv) as communicator:
	...
	if not printer:
		...
		#	print(row[0])
		while True:
			print("Que voulez vous faire ? -> Afficher, Ajouter, Avancer, Changer, Modifier, Play, Pause, RechercheArtiste, RechercheTitre, Reculer, Stop, Supprimer, Quitter")
			choice = input()
			...
			elif choice.lower() == "rechercheartiste":
			...
			elif choice.lower() == "recherchetitre":
