...
if 'PlayerPrx' not in _M_MusicPlayer.__dict__:
    ...
    class PlayerPrx(Ice.ObjectPrx):
        ...
        def SearchArtist(self, artist, context=None):
            return _M_MusicPlayer.Player._op_SearchArtist.invoke(self, ((artist, ), context))

        def SearchArtistAsync(self, artist, context=None):
            return _M_MusicPlayer.Player._op_SearchArtist.invokeAsync(self, ((artist, ), context))

        def begin_SearchArtist(self, artist, _response=None, _ex=None, _sent=None, context=None):
            return _M_MusicPlayer.Player._op_SearchArtist.begin(self, ((artist, ), _response, _ex, _sent, context))

        def end_SearchArtist(self, _r):
            return _M_MusicPlayer.Player._op_SearchArtist.end(self, _r)
        ...
        def Reculer(self, context=None):
            return _M_MusicPlayer.Player._op_Reculer.invoke(self, ((), context))

        def ReculerAsync(self, context=None):
            return _M_MusicPlayer.Player._op_Reculer.invokeAsync(self, ((), context))

        def begin_Reculer(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_MusicPlayer.Player._op_Reculer.begin(self, ((), _response, _ex, _sent, context))
    ...
    Player._op_SearchTitle = IcePy.Operation('SearchTitle', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), ((), _M_MusicPlayer._t_StringSeq, False, 0), ())
    Player._op_SearchArtist = IcePy.Operation('SearchArtist', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), ((), _M_MusicPlayer._t_StringSeq, False, 0), ())
    Player._op_Avancer = IcePy.Operation('Avancer', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
    Player._op_Reculer = IcePy.Operation('Reculer', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
