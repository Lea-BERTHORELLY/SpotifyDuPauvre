...
{
    default String GetMusics()
    {
        return GetMusics(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String GetMusics(java.util.Map<String, String> context)
    {
        return _iceI_GetMusicsAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> GetMusicsAsync()
    {
        return _iceI_GetMusicsAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> GetMusicsAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_GetMusicsAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "GetMusics", null, sync, null);
    ...
    default void PrintMusics(String music)
    {
        PrintMusics(music, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void PrintMusics(String music, java.util.Map<String, String> context)
    {
        _iceI_PrintMusicsAsync(music, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> PrintMusicsAsync(String music)
    {
        return _iceI_PrintMusicsAsync(music, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> PrintMusicsAsync(String music, java.util.Map<String, String> context)
    {
        return _iceI_PrintMusicsAsync(music, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_PrintMusicsAsync(String iceP_music, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "PrintMusics", null, sync, null);
        f.invoke(false, context, null, ostr -> {
