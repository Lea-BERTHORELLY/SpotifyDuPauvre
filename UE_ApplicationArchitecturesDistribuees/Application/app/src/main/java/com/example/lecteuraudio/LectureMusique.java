...
public class LectureMusique extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lecture_musique);
        ...
        String auteurs = intent.getStringExtra("auteur");
        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mediaPlayer.isPlaying()) {
                   ...
                   // btnPlay.setBackgroundDrawable(@android:drawable/ic_media_pause);
                    ...
                    //btnPlay.setBackgroundResource(@android:drawable/ic_media_pause);
